...
/**
 * Created by Rinav Gangar <rinav.dev> on 18/5/20.
 * Agrahyah Technologies Pvt Ltd
 * rinav4all@gmail.com
 */


/** [Presenter] used to display a album item as an image card */
class AlbumPresenter(private val cardHeight: Int = DEFAULT_CARD_HEIGHT) : Presenter() {
