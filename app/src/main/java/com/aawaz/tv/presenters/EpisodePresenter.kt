...
/**
 * Created by Rinav Gangar <rinav.dev> on 21/7/20.
 * Agrahyah Technologies Pvt Ltd
 * rinav4all@gmail.com
 */

/** [Presenter] used to display a episode item as an image card */
class EpisodePresenter(private val cardHeight: Int = DEFAULT_CARD_HEIGHT) : Presenter() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, item: Any) {
        ...
        card.titleText = episode.tTitle
        //card.contentText = episode.tDescription
        ...
        val request = LoadRequest.Builder(card.context)
            .data(episode.tArt ?: R.drawable.logo_grey_sm_en)
            //.crossfade(true)
            .size(cWidth, cHeight)
            ...
            .transition(PaletteTransition(CrossfadeTransition()) { palette ->
                ...
                Utils.episodeColors[item.tId] = colors
